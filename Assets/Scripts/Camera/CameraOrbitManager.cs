...
public class CameraOrbitManager : MonoBehaviour
{
    ...
    // Alterna el estado de la camara cinemachine
    private void AlternateCinemachine() => cameraData.enabled = !cameraData.enabled;


    // suscripción al delegado 
    private void OnEnable() => MouseVisibilityManager.MouseRelease += AlternateCinemachine;

    // desuscripción al delegado 
